...
export default function Order(){
    ...
    const [productSelected, setProductSelect] = useState<ProductProps | undefined>()
    ...
    async function handleAdd(){
        try {
            ...
            console.log("Erro ao adicionar item no pedido.", error)
        }
    }
    ...
    return(
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                {items.length === 0 && (
                    <TouchableOpacity onPress={handlCloseOrder}>
